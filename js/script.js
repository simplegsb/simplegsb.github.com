...
function homeSweetHomeMap()
{
    ...
    var map = new google.maps.Map(document.getElementById('map'), {zoom : 2, center : latlng, mapTypeId : google.maps.MapTypeId.ROADMAP});
    ...
    for (index in path)
    {
        new google.maps.Marker({position: path[index], map: map, icon: 'images/home.png'});
    }
...
function thePhilippinesMap()
{
    ...
    var map = new google.maps.Map(document.getElementById('map'), {zoom : 7, center : latlng, mapTypeId : google.maps.MapTypeId.ROADMAP});
    ...
    for (index in path)
    {
        new google.maps.Marker({position: path[index], map: map, icon: 'images/travel.png'});
    }
...
function ozMap()
{
    ...
    var map = new google.maps.Map(document.getElementById('map'), {zoom : 5, center : latlng, mapTypeId : google.maps.MapTypeId.ROADMAP});
...
function gertrudeMap()
{
    ...
    var map = new google.maps.Map(document.getElementById('map'), {zoom : 4, center : latlng, mapTypeId : google.maps.MapTypeId.ROADMAP});
